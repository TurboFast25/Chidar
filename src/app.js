...
// MAJOR_OBJECTS, clamp, normalizeLabel, and other pure functions are imported from ./logic.js
...
async function generate() {
  ...
  try {
    ...
    state.layoutModel = buildLayoutModel(state.roomModel, state.analysis, state.manualOpenings, state.suppressInferredOpenings);
...
// inferOpenings is imported from ./logic.js

// buildLayoutModel is imported from ./logic.js
...
// buildManualDoor, buildManualWindow are imported from ./logic.js
...
// getObjectFootprintBounds, getObjectFootprintCenter, findObjectAtPlanPoint are imported from ./logic.js
...
// deriveDepthZone, deriveSideZone, overlapsRect are imported from ./logic.js
...
// snapObjectToZone, resolveObjectCollisions are imported from ./logic.js
...
// objCenter, doorPoint, distToPoint, isAgainstWall, isAgainstAnyWall,
// entryCorridor, baguaZone, objectElement, buildFengShuiModel
// are all imported from ./logic.js
...
// buildMeshFromFloorPlan, cleanMesh are imported from ./logic.js
